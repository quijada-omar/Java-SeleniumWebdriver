...
public class FixedDepositCalculator {
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String file=System.getProperty("user.dir")+"\\testdata\\depositdata.xlsx";
		
		String sheet = "Hoja 1";
		int rows=ExcelUtils.getRowCount(file, sheet);
...
//			 Read data from excel
			//read data from excel
			String princ=ExcelUtils.getCellData(file,sheet,i,0);
			String rateofinterest=ExcelUtils.getCellData(file,"Sheet1",i,1);
			String per1=ExcelUtils.getCellData(file,sheet,i,2);
			String per2=ExcelUtils.getCellData(file,sheet,i,3);
			String fre=ExcelUtils.getCellData(file,sheet,i,4);
			String exp_mvalue=ExcelUtils.getCellData(file,sheet,i,5);
